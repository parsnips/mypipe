...
lazy val kinesisDependencies = Seq(
  awsKinesis,
  scalaTest
)
...
lazy val root = (project in file(".")).
  ...
  aggregate(api, producers, runner, myavro, mykafka, mykinesis)
...
lazy val runner = (project in file("mypipe-runner")).
  ...
  settings(Format.settings) dependsOn(api, producers, myavro, mykafka, mykinesis)
...
lazy val mykinesis = (project in file("mypipe-kinesis")).
  settings(commonSettings: _*).
  settings(
    name := "mykinesis",
    fork in run := false,
